...
#for i in testing:
    ...
    try:
        ...
        channel.recv(1024)
        channel.send("xcommand SystemUnit Boot\n")
        result1.write(i,3,'Codec Rebooted')
        channel.close()
...
if os.path.isfile(r'C:\Users\svc_it.audiovisual\Desktop\Script\RebootMetal\CodecResult.xls'):
    os.remove(r'C:\Users\svc_it.audiovisual\Desktop\Script\RebootMetal\CodecResult.xls')
    result.save(r'C:\Users\svc_it.audiovisual\Desktop\Script\RebootMetal\CodecResult.xls')
else:
    result.save(r'C:\Users\svc_it.audiovisual\Desktop\Script\RebootMetal\CodecResult.xls')
...
fp = open(r'C:\Users\svc_it.audiovisual\Desktop\Script\RebootMetal\CodecResult.xls', 'rb')

file1=email.mime.base.MIMEBase('application','vnd.ms-excel')
file1.set_payload(fp.read())
fp.close()
email.encoders.encode_base64(file1)
file1.add_header('Content-Disposition','attachment;filename=CodecRebootResult.xls')




msg['Subject'] = "Reboot Codec Report"
if Issue == 0:
    body = "All CKS are rebooting (" + str(Tested) + "Tested)"
else:
    body = "Results : " + str(Issue) + " Codec over " + str(Tested) + " have trouble. Please look at the file attached"
